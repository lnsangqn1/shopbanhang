                                ...
                                <div class="address1">
                                    <h3>Our Phone:<h3>
                                            ...
                                            <div class="col-md-6 contact-top">
                                                ...
                                                <form name="frmcontact" method="post" action="ProcessContact">
                                                    <div>
                                                        <span>Your Name </span>		
                                                        <input name="yourn" type="text" value="" required="">						
                                                    </div>
                                                    <div>
                                                        <span>Your Email </span>		
                                                        <input name="youre" type="text" value="" required="">						
                                                    </div>
                                                    <div>
                                                        <span>Subject</span>		
                                                        <input name="yours" type="text" value="" required="" >	
                                                    </div>
                                                    <div>
                                                        <span>Your Message</span>		
                                                        <textarea name="yourm"> </textarea>	
                                                    </div>
